#include <Wire.h>                                                                              // Including Wire library for the I2C Connected to the LCD Display
#include <LiquidCrystal_I2C.h>                                                                 // Including Liquid crystal library for I2C
#include "DHT.h"                                                                               // Including DHT library for DHT11 Temperature and Humidity Sensor
